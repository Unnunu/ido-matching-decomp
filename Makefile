...
CHECK_WARNINGS := -Wall -Wextra -Wno-unknown-pragmas -Wno-unused-variable -Wno-char-subscripts -Wno-unused-label -Wno-parentheses -Wno-unused-parameter -Wno-pointer-sign -Wno-implicit-int
...
build/src/7.1/libp/%.o: OPTFLAGS := -O2
build/src/7.1/mld/%.o: OPTFLAGS := -O2
